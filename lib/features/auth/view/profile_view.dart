...
class _ProfileViewState extends State<ProfileView> {
  ...
  void initState() {
    ...
    getProfileData().then((v) {
      _name.text = userModel?.name.toString() ?? 'Mahmoud';
      _email.text = userModel?.email.toString() ?? 'MahmoudZizo@gmail.com';
      _address.text =
      userModel?.address == null ? "Hurghada, Egy" : userModel!.address!;
    });
    super.initState();
  }
